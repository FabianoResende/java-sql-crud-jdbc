...
Este projeto roda localmente via terminal/IDE.  
Ele demonstra:

- Conexão com banco SQLite  
- CRUD completo  
- Arquitetura limpa (DAO + Model + ConnectionFactory)  
...
Criar uma aplicação Java simples, modular e escalável, com foco em:
...
│   ├── database/            # ConnectionFactory e SQLite
